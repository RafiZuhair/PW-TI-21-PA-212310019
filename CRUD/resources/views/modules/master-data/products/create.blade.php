<div class="card border-0">
    ...
    <div class="card-body pt-0">
        ...
        <form action={{ url('/master-data/products') }} method="post" autocomplete="off" id="form-product">
            ...
            <div class="text-end">
                <button
                    class="py-2 px-4 bg-red-500 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
