...
Route::controller(UsersController::class)->group(function (){
    Route::get('/tugas-data/users', 'index')->name('m_user');
    Route::post('/tugas-data/users', 'store');
    Route::get('/tugas-data/users/edit/{id}', 'edit')->name('m_user_edit');
    Route::get('/tugas-data/users/remove/{id}', 'destroy')->name('m_user_remove');
});
